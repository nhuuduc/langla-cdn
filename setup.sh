...
setup_safeline_files() {
    ...
    info "正在下载 docker-compose.yaml 脚本..."
    curl -4sSLk https://waf-ce.chaitin.cn/release/latest/compose.yaml -o docker-compose.yaml || abort "下载 docker-compose.yaml 脚本失败"
